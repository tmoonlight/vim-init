...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 83 - ((1 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
83
...
190
normal! zo
let s:l = 202 - ((25 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
202
...
badd +1 init.vim
badd +1 init/init-basic.vim
badd +1 init/init-config.vim
