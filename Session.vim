...
inoremap <M-h> <C-Left>
inoremap <silent> <M-0> :tabn 10
inoremap <silent> <M-9> :tabn 9
inoremap <silent> <M-8> :tabn 8
inoremap <silent> <M-7> :tabn 7
inoremap <silent> <M-6> :tabn 6
inoremap <silent> <M-5> :tabn 5
inoremap <silent> <M-4> :tabn 4
inoremap <silent> <M-3> :tabn 3
inoremap <silent> <M-2> :tabn 2
inoremap <silent> <M-1> :tabn 1
cnoremap <C-_> 
cnoremap <C-D> <Del>
cnoremap <C-B> <Left>
cnoremap <C-F> 
...
noremap  nm :NERDTreeMirror
noremap  no :NERDTreeFocus
noremap  nn :NERDTree
noremap <silent>  ha :RemoveErrorMarkers
...
noremap <silent> ,tr :call Tab_MoveRight()
noremap <silent> ,tl :call Tab_MoveLeft()
noremap <silent> ,to :tabonly
noremap <silent> ,tp :tabprev
noremap <silent> ,tn :tabnext
noremap <silent> ,tq :tabclose
noremap <silent> ,tc :tabnew
noremap <silent> ,bp :bp
noremap <silent> ,bn :bn
...
noremap ; :
inoremap <silent> ° :tabn 10
inoremap <silent> ¹ :tabn 9
inoremap <silent> ¸ :tabn 8
inoremap <silent> · :tabn 7
inoremap <silent> ¶ :tabn 6
inoremap <silent> µ :tabn 5
inoremap <silent> ´ :tabn 4
inoremap <silent> ³ :tabn 3
inoremap <silent> ² :tabn 2
inoremap <silent> ± :tabn 1
inoremap Ë k
inoremap Ê j
inoremap Ì l
inoremap È h
...
noremap <silent> <F2> :AsyncRun! -cwd=<root> grep -n -s -R   --include='*.h' --include='*.c*' --include='*.py'  --include='*.js' --include='*.vim' '<root>' 
nnoremap <silent> <F3> :tabdo w  :mks! 
nnoremap <silent> <F4> :AsyncRun -cwd=<root> cmake . 
nnoremap <silent> <F7> :AsyncRun -cwd=<root> -raw make test 
nnoremap <silent> <F5> :AsyncRun -cwd=<root> -raw make run 
nnoremap <silent> <F6> :AsyncRun -cwd=<root> make 
nnoremap <silent> <F9> :AsyncRun gcc -Wall -O2 "$(VIM_FILEPATH)" -o "$(VIM_FILEDIR)/$(VIM_FILENOEXT)" -lstdc++ 
...
noremap <M-l> w
noremap <M-h> b
noremap <silent> <M-Right> :call Tab_MoveRight()
noremap <silent> <M-Left> :call Tab_MoveLeft()
noremap <silent> <M-t> :tabnew . 
nnoremap <C-S> :w
noremap <silent> <M-0> :tabn 10
noremap <silent> <M-9> :tabn 9
noremap <silent> <M-8> :tabn 8
noremap <silent> <M-7> :tabn 7
noremap <silent> <M-6> :tabn 6
noremap <silent> <M-5> :tabn 5
noremap <silent> <M-4> :tabn 4
noremap <silent> <M-3> :tabn 3
noremap <silent> <M-2> :tabn 2
noremap <silent> <M-1> :tabn 1
noremap <C-L> <Right>
noremap <C-K> <Up>
noremap <C-J> <Down>
noremap <C-H> <Left>
...
noremap <M-m> :LeaderfTag
noremap <M-n> :LeaderfBuffer
noremap <M-P> :LeaderfBufTag!
noremap <M-p> :LeaderfFunction!
...
noremap ì w
noremap è b
noremap <silent> ô :tabnew . 
noremap í :LeaderfTag
noremap î :LeaderfBuffer
noremap Ð :LeaderfBufTag!
noremap ð :LeaderfFunction!
nmap å <Plug>(choosewin)
let &cpo=s:cpo_save
unlet s:cpo_save
...
set errorformat=%*[^\"]\"%f\"%*\\D%l:\ %m,\"%f\"%*\\D%l:\ %m,%-G%f:%l:\ (Each\ undeclared\ identifier\ is\ reported\ only\ once,%-G%f:%l:\ for\ each\ function\ it\ appears\ in.),%-GIn\ file\ included\ from\ %f:%l:%c:,%-GIn\ file\ included\ from\ %f:%l:%c\\,,%-GIn\ file\ included\ from\ %f:%l:%c,%-GIn\ file\ included\ from\ %f:%l,%-G%*[\ ]from\ %f:%l:%c,%-G%*[\ ]from\ %f:%l:,%-G%*[\ ]from\ %f:%l\\,,%-G%*[\ ]from\ %f:%l,%f:%l:%c:%m,%f(%l):%m,%f:%l:%m,\"%f\"\\,\ line\ %l%*\\D%c%*[^\ ]\ %m,%D%*\\a[%*\\d]:\ Entering\ directory\ %*[`']%f',%X%*\\a[%*\\d]:\ Leaving\ directory\ %*[`']%f',%D%*\\a:\ Entering\ directory\ %*[`']%f',%X%*\\a:\ Leaving\ directory\ %*[`']%f',%DMaking\ %*\\a\ in\ %f,%f|%l|\ %m,[%f:%l]\ ->\ %m,[%f:%l]:%m
...
set ruler
set runtimepath=~/.vim,~/.vim/bundles/vim-easymotion,~/.vim/bundles/vim-dirvish,~/.vim/bundles/vim-diff-enhanced,~/.vim/bundles/vim-startify,~/.vim/bundles/vim-colorschemes,~/.vim/bundles/vim-misc,~/.vim/bundles/vim-signature,~/.vim/bundles/vim-signify,~/.vim/bundles/errormarker.vim,~/.vim/bundles/vim-choosewin,~/.vim/bundles/vim-preview,~/.vim/bundles/vim-fugitive,~/.vim/bundles/vim-expand-region,~/.vim/bundles/fzf,~/.vim/bundles/vim-dict,~/.vim/bundles/FlyGrep.vim,~/.vim/bundles/ctrlsf.vim,~/.vim/bundles/delimitMate,~/.vim/bundles/vim-gutentags,~/.vim/bundles/gutentags_plus,~/.vim/bundles/vim-textobj-user,~/.vim/bundles/vim-textobj-indent,~/.vim/bundles/vim-textobj-syntax,~/.vim/bundles/vim-textobj-function,~/.vim/bundles/vim-textobj-parameter,~/.vim/bundles/vim-textobj-python,~/.vim/bundles/vim-textobj-uri,~/.vim/bundles/vim-ps1,~/.vim/bundles/vim-lua,~/.vim/bundles/vim-cpp-enhanced-highlight,~/.vim/bundles/python-syntax,~/.vim/bundles/vim-orgmode,~/.vim/bundles/vim-airline,~/.vim/bundles/vim-airline-themes,~/.vim/bundles/vim-nerdtree-syntax-highlight,~/.vim/bundles/ale,~/.vim/bundles/echodoc.vim,~/.vim/bundles/LeaderF,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after,~/.vim/bundles/YouCompleteMe,~/.vim/bundles/vim-signature/after,~/.vim/bundles/ctrlsf.vim/after,~/.vim/bundles/vim-textobj-function/after,~/.vim/bundles/vim-textobj-python/after,~/.vim/bundles/vim-cpp-enhanced-highlight/after,~/.vim/bundles/vim-nerdtree-syntax-highlight/after,~/.vim/vim-init
set shiftwidth=4
...
setlocal define=
setlocal dictionary=~/.vim/bundles/vim-dict/dict/vim.dic
setlocal nodiff
setlocal equalprg=
...
setlocal tagcase=
setlocal tagfunc=
setlocal tags=~/.cache/tags/home-shao-.vim-vim-init-.tags,./.tags;,.tags
set termwinkey=<c-_>
...
let s:l = 94 - ((52 * winheight(0) + 26) / 53)
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 146 - ((26 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
146
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 69 - ((26 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
69
...
190
normal! zo
let s:l = 202 - ((26 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
202
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 223 - ((26 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
223
...
tabnext 5
badd +0 init.vim
badd +1 init/init-plugins.vim
badd +0 init/init-basic.vim
badd +0 init/init-config.vim
badd +0 init/init-keymaps.vim
